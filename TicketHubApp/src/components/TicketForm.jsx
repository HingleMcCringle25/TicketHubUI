...
function TicketForm() {
  ...
  const concertIdFromURL = searchParams.get('concertId');

  console.log("TicketForm location.state:", location.state);
  console.log("TicketForm formData:", formData);
  console.log("TicketForm quantity:", quantity);
  console.log("TicketForm concertId from URL:", concertIdFromURL);
  ...
  return (
    <Container className="py-5 d-flex align-items-center justify-content-center">
      <Row className="w-100justify-content-md-center">
